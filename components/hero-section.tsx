...
export function HeroSection() {
  return (
    <section className="relative flex w-full h-full max-h-svh aspect-video flex-col items-center justify-center overflow-hidden px-6 md:px-16 lg:px-24">
      {/* Background grid */}
      <div
        aria-hidden
      ...
      <div
        className={
          "flex flex-row justify-start items-center w-full h-full max-w-400"
        }
      >
